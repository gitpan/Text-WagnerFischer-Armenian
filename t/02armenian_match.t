...
is( distance( $new_distances, "կինք", "կին" ), 1, "Armenian suffix doubled" );
is( distance( $new_distances, "զկին", "կին" ), 1, "Armenian prefix doubled" );
is( distance( $new_distances, "Æble", "Able" ), 2, "normal substitution doubled" );
is( distance( $new_distances, "Able", "ble" ), 2, "normal deletion doubled" );
is( distance( $new_distances, "able", "able" ), 0, "identical strings doubled" );
is( distance( $new_distances, "զձեռն", "ձեռնն" ), 2, "Armenian prefix + suffix doubled" );
is( distance( $new_distances, "ձեռն", "ձեռան" ), 2, "normal Arm insertion doubled" );
is( distance( $new_distances, "աղօթեալ", "ախօթեալք" ), 3, "Armenian suffix + substitution doubled" );
is( distance( $new_distances, "զզօրս", "զորս" ), 2, "Armenian prefix + vocalic equivalence doubled" );
...
is( distance( $new_distances, "apple", "a*ple" ), 2, "Pattern metacharacters are safe doubled" );
